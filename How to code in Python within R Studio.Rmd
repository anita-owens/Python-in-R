...
sns.catplot(data=credit, x="Cards", y="Balance", hue="Gender", kind="box")
plt.show()
plt.clf()

sns.catplot(data=credit, x="Cards", y="Balance", hue="Student", kind="box")
plt.show()
plt.clf()
...
#Store column names for objects
...
credit_final = credit_encoded.merge(right=scaled_numerical,
                        how='left',
                        left_index=True, #left join equivalent in SQL
                        right_index = True)
